...
import { AddPostLesson } from "../../store/action/actionCreator/actionLesson";
...
class CreatePostLesson extends Component {
  handleSubmitCreatPost = values => {
    this.props.AddPostLesson(values.text, this.props.id);
  };
      ...
      >
        {props => (
          ...
          >
            ...
            <hr style={{ width: "103.5%", marginRight: "-1.8%" }} />
            <div
              className=""
              style={{
                display: "flex",
...
const mapDispatchToProps = dispatch => {
  return {
    AddPostLesson: (text, id) => dispatch(AddPostLesson(text, id))
  };
};
